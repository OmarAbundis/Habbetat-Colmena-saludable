...
Hasta este momento, se tiene resuelto la detección de las variables de interés, peso de la colmena, temperatura y humedad ambientales cercanas a la colmena y la activación de un actuador que se pueda conectar al suministro eléctrico de 127 Vca a 60Hz, estándar en México. Pero, todavía le faltan más implementaciones para que sea considerado como parte del ecosistema del Internet de las cosas. Por ejemplo, ya desde hace mucho tiempo si estas subscrito a alguna plataforma de *streaming*, que entre más haces uso de ella empieza después de un determinado tiempo, a sugeriste temas de tú interés, aunque tú no hayas empezado alguna búsqueda. ¿Cómo se realiza?

...
** Antes de subir el código hay que cerciorrase que el GPIO del ESP32 CAM esté conectado a GND para entrar en el modo programador, después de subir el código desconectarlos

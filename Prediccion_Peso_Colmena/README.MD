...
R. Si, se puede pero es una buena práctica crear los ambientes virtuales para ejecutar proyectos de este tipo para encapuslar las dependendicias y no intereactuen con algunas otras instalciones.
